...
class ComputeUnit(RootModel[float]):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    root: float = Field(..., gte=0.25)
...
class ProjectConsumption(BaseModel):
    ...
    data_storage_bytes_hour: int = Field(
        ...,
    ...
    data_transfer_bytes_updated_at: AwareDatetime | None = Field(
        None,
        description="Timestamp of the last update of `data_transfer_bytes` field\n",
    )
    written_data_bytes: int = Field(
        ...,
    ...
    written_data_bytes_updated_at: AwareDatetime | None = Field(
        None,
        description="The timestamp of the last update of `written_data_bytes` field.\n",
    )
    compute_time_seconds: int = Field(
        ...,
    ...
    compute_time_seconds_updated_at: AwareDatetime | None = Field(
        None,
    ...
    active_time_seconds_updated_at: AwareDatetime | None = Field(
        None,
    ...
    previous_period_id: UUID | None = Field(
...
class EndpointPoolerMode(RootModel[Literal["transaction"]]):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    root: Literal["transaction"] = Field(
        ...,
        description="The connection pooler mode. Neon supports PgBouncer in `transaction` mode only.\n",
    )


class SuspendTimeoutSeconds(RootModel[int]):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    root: int = Field(
...
class PgbouncerSettingsData(RootModel[dict[str, str] | None]):
    """
...
class Operation(BaseModel):
    ...
    branch_id: str | None = Field(None, description="The branch ID")
    endpoint_id: str | None = Field(None, description="The endpoint ID")
    action: OperationAction
    status: OperationStatus
    error: str | None = Field(None, description="The error that occured")
    failures_count: int = Field(
        ..., description="The number of times the operation failed"
    )
    retry_at: AwareDatetime | None = Field(
...
class ProjectSettingsData(BaseModel):
    ...
    enable_logical_replication: bool | None = Field(
        None,
...
class Branch1(BaseModel):
    ...
    last_reset_at: AwareDatetime | None = Field(
...
class BranchCreateRequestEndpointOptions(BaseModel):
    ...
    type: EndpointType
    autoscaling_limit_min_cu: ComputeUnit | None = Field(
        None,
    ...
    autoscaling_limit_max_cu: ComputeUnit | None = Field(
        None,
        description="The maximum number of Compute Units.\n    See [Compute size and Autoscaling configuration](https://neon.tech/docs/manage/endpoints#compute-size-and-autoscaling-configuration)\n    for more information.\n",
    )
    provisioner: Provisioner | None = None
    suspend_timeout_seconds: SuspendTimeoutSeconds | None = None
...
class EndpointSettingsData(BaseModel):
    ...
    pg_settings: PgSettingsData | None = None
    pgbouncer_settings: PgbouncerSettingsData | None = None
...
class ProjectListItem(BaseModel):
    ...
    maintenance_starts_at: AwareDatetime | None = Field(
        None,
    ...
    synthetic_storage_size: int | None = Field(
        None,
...
class Project1(BaseModel):
    ...
    store_passwords: bool | None = Field(
        None,
        description="Whether or not passwords are stored for roles in the Neon project. Storing passwords facilitates access to Neon features that require authorization.\n",
    )
    history_retention_seconds: int | None = Field(
        None,
...
class Endpoint(BaseModel):
    ...
    autoscaling_limit_min_cu: ComputeUnit = Field(
        ..., description="The minimum number of Compute Units\n"
    )
    autoscaling_limit_max_cu: ComputeUnit = Field(
        ..., description="The maximum number of Compute Units\n"
    )
    region_id: str = Field(..., description="The region identifier\n")
    type: EndpointType
...
class Endpoint1(BaseModel):
    ...
    provisioner: Provisioner | None = None
    pooler_enabled: bool | None = Field(
        None,
    ...
    passwordless_access: bool | None = Field(
        None,
